...
export default class Ficha extends Component {
	...
	calcularHabilidadesValidas = () => {
		...
		let { listaHabilidadesEscolhidas } = this.state

		listaHabilidadesEscolhidas = []
		if (habilidadeRaca)
			listaHabilidadesEscolhidas.push(habilidadeRaca)
		if (habilidadeClasse)
			listaHabilidadesEscolhidas.push(habilidadeClasse)

		this.setState({ listaHabilidadesEscolhidas: listaHabilidadesEscolhidas })
	}
	/*
